...
export default function Home() {
  ...
  return (
    <main className="flex items-center justify-center flex-col">
            ...
            titleComponent={
              <div className="flex items-center flex-col">
                {isLoggedIn ? (
                  <Link href="/dashboard">
                    <div
                      className="p-8 mb-8 md:mb-0 text-2xl h-10 px-8 w-full sm:w-fit border-t-2 rounded-full border-[#4D4D4D] bg-[#1F1F1F] hover:bg-white group transition-all flex items-center justify-center gap-4 hover:shadow-xl hover:shadow-neutral-500 duration-500 cursor-pointer pointer-events-auto"
                    >
      ...
      <section className="mt-[-250px] md:mt-[-500px]">

        <LampComponent />

        <div className="flex flex-wrap items-center justify-center flex-col md:flex-row gap-8 -mt-[250px] md:-mt-72">
